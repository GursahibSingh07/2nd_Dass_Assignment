"""Game loop and state management for a MoneyPoly session."""
...
class Game:
    ...
    def _apply_card(self, player, card):
        ...
        if action == "collect":
            ...
            self._apply_card_move_to(player, value)
    ...
    def _apply_card_move_to(self, player, value):
        """Teleport player to a board position and resolve the tile."""
