"""Card definitions and deck logic for MoneyPoly.

This module defines the Chance and Community Chest cards, along with
the CardDeck class used to manage drawing, peeking, and reshuffling cards.
"""
import random
...
class CardDeck:
    ...
    def cards_remaining(self):
        """Return how many cards remain before the first full cycle completes."""
        if not self.cards:
            return 0
        return max(len(self.cards) - self.index, 0)
