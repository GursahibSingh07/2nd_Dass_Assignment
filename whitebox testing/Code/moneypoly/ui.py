"""Console output and input utilities for the MoneyPoly game.

This module provides helper functions for displaying formatted game
information in the terminal, including player summaries, standings,
and property ownership tables. It also includes small input utilities
for safe user interaction.
"""
